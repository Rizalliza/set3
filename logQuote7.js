...
class RPCManager {
    constructor() {
        ...
        const privateUrl = process.env.RPC_URL || 'https://mainnet.helius-rpc.com/?api-key=2abdf423-a7a5-43a1-9912-438f00454906';
        this.endpoints.push({
            url: privateUrl,
            connection: null,
            failed: false,
...
async function main() {
    ...
    const poolsFile = args[0] || 'stage1_pools.json';
    ...
    try {
        // Load and categorize
        const pools = fetchPools(poolsFile);
...
//.  node logQuote7.js ./stage1_pools_enriched.json --mode quote 5 --verbose